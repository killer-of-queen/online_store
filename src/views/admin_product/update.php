...
<main class="main wrapper user-cabinet__wrapper">
    ...
    <form class="admin__product__update__form" method="post" action="/admin/product/update/<?php echo $product['id']?>">
        <div>
            ...
            <input id="price" class="registration__field contact_field" value="<?php echo $product['price'];?>" type="number" name="price">
